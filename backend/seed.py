...
def seed():
    ...
    with app.app_context():
        ...
        # ── Students ──
        students_seed = [
            {'full_name': 'Fatima Malik',     'email': 'fatima.malik@st.habib.edu.pk',     'phone': '+923004444441'},
            {'full_name': 'Usman Ahmed',      'email': 'usman.ahmed@st.habib.edu.pk',     'phone': '+923004444442'},
            {'full_name': 'Zainab Raza',      'email': 'zainab.raza@st.habib.edu.pk',     'phone': '+923004444443'},
            {'full_name': 'Omar Farooq',      'email': 'omar.farooq@st.habib.edu.pk',     'phone': '+923004444444'},
            {'full_name': 'Ayesha Siddiqui',  'email': 'ayesha.siddiqui@st.habib.edu.pk', 'phone': '+923004444445'},
            {'full_name': 'Bilal Sheikh',     'email': 'bilal.sheikh@st.habib.edu.pk',    'phone': '+923004444446'},
        ]
