      ...
      <div className="auth-container">
        <div className="auth-card">
          ...
          <form onSubmit={handleSubmit} className="auth-form">
            ...
            <p className="resend-text" style={{ fontSize: '0.75rem' }}>💡 Check the Flask backend terminal for the code</p>
          ...
          <div className="auth-footer">
            <p>Didn&apos;t get the code? <Link to="/forgot-password" className="form-link">Try again</Link></p>
          </div>
        </div>
      </div>
    </div>
