    ...
    <div className="auth-page">
      <nav className="navbar">
        <div className="navbar-container">
          <Link to="/" className="navbar-brand"><span className="brand-icon">🎓</span><span className="brand-text">CampusTutor</span></Link>
        </div>
      </nav>
      <div className="auth-container">
        <div className="auth-card">
          <div className="auth-header"><h1>Welcome Back</h1><p>Log in to your CampusTutor account</p></div>
          ...
          <div className="auth-footer"><p>Don&apos;t have an account? <Link to="/signup" className="form-link">Sign up</Link></p></div>
        </div>
      </div>
    </div>
  );
